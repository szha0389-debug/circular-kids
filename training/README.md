...
three pooling stages it uses Flatten, one 128-unit dense layer, and a 23-class
Softmax output. It does not
load a checkpoint, TensorFlow Hub model, or any other pretrained model.
