...
.ck-tile:hover { border-color: rgba(231,124,98,.5); transform: translateY(-3px); box-shadow: 0 16px 34px rgba(37,49,46,.075); }
...
.ck-tile.is-chosen {
  ...
  box-shadow: 0 12px 26px rgba(231,124,98,.12);
}
